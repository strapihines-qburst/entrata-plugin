...
export interface PluginEntratafeedFloorplan
  ...
  attributes: {
    ...
    floorplan_image: Schema.Attribute.String;
...
export interface PluginEntratafeedPropertySetting
  ...
  info: {
    ...
    pluralName: 'property-settings';
    singularName: 'property-setting';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::entratafeed.property-setting'
    > &
      Schema.Attribute.Private;
    popupSpecial: Schema.Attribute.Component<
      'plugin::entratafeed.special-details',
      false
    >;
    propertyId: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    topSpecial: Schema.Attribute.Component<
      'plugin::entratafeed.special-details',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface PluginEntratafeedSpecial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::entratafeed.special'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    special_id: Schema.Attribute.String;
    special_type: Schema.Attribute.Enumeration<
      ['floorplan', 'unit', 'floorplanType']
    > &
      Schema.Attribute.Required;
    specials: Schema.Attribute.Component<
      'plugin::entratafeed.special-details',
      false
    >;
    units: Schema.Attribute.Relation<'oneToMany', 'plugin::entratafeed.unit'>;
...
export interface PluginEntratafeedUnit extends Struct.CollectionTypeSchema {
